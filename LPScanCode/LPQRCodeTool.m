...
+ (UIImage *)generateWithDefaultQRCodeData:(NSString *)data imageViewWidth:(CGFloat)imageViewWidth {
    ...
    return [LPQRCodeTool createNonInterpolatedUIImageFormCIImage:outputImage withSize:imageViewWidth];
}
...
+ (UIImage *)generateWithLogoQRCodeData:(NSString *)data logoImageName:(UIImage *)logoImageName logoScaleToSuperView:(CGFloat)logoScaleToSuperView {
    ...
    UIBezierPath *bezierPath =[UIBezierPath bezierPathWithRoundedRect:(CGRect){CGPointMake(icon_imageX, icon_imageY), CGSizeMake(icon_imageW, icon_imageH)}
                                                         cornerRadius:10];
    ...
    [icon_image drawInRect:(CGRect){CGPointZero, CGSizeMake(icon_imageW, icon_imageH)}];
